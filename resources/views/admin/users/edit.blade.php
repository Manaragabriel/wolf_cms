        ...
        <div class="container-fluid ">
            ...
            <div class="card  card-primary bg-white">
                <div class="card-header">
                    <h3 class="card-title">Formulário para editar Usuários</h3>
                </div>

                <div class="card-body">
                    <form method="POST" action="/admin/usuarios/{{$user->id}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        {{method_field('PUT')}}
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="is_admin" value="1" id="is_admin" {{$user->is_admin || old('is_admin') ? 'checked' : ''}}
                                        /> Sim
                                </div>
                                @error('is_admin')
