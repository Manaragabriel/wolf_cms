    ...
    <div class="container">
        <div class="row py-5">
            ...
            <div class="col-lg-12">
               ...
               <div> 
                    <h1 class="text-white  text-center font-weight-bold py-3 h2">ECOMMERCE</h1>
                    <p class="text-white text-center">Criamos e implementamos soluções de ECOMMERCE, com plataforma própria, oferecendo qualidade e eficiência.
                        <br>
                        Sem comissão sobre suas vendas, e com mensalidades acessívéis, para que você possa vender na internet com facilidade.
                        <br>
                        Não perca mais tempo, TRAGA SEU NEGÓCIO PARA O MUNDO DIGITAL!
                     </p>
