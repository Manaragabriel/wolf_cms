    ...
    <div class="page-wrapper">
       ...
       <section id="top-content" class="p-5 ">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="gallery-item-three">
                            <img src="/assets_site/images/update-1-12-2020/projects/project-1-1.jpg" alt="">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="gallery-item-three">
                            <img src="/assets_site/images/update-1-12-2020/projects/project-1-2.jpg" alt="">
                            <div class="gallery-item-three__content">
                                <p>Project List</p>
                                <h3><a href="portfolio-single.html">Substantial
                                        Growth</a></h3>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="gallery-item-three">
                            <img src="/assets_site/images/update-1-12-2020/projects/project-1-3.jpg" alt="">
                            <div class="gallery-item-three__content">
                                <p>Project List</p>
                                <h3><a href="portfolio-single.html">Substantial
                                        Growth</a></h3>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="gallery-item-three">
                            <img src="/assets_site/images/update-1-12-2020/projects/project-1-4.jpg" alt="">
                            <div class="gallery-item-three__content">
                                <p>Project List</p>
                                <h3><a href="portfolio-single.html">Substantial
                                        Growth</a></h3>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="gallery-item-three">
                            <img src="/assets_site/images/update-1-12-2020/projects/project-1-5.jpg" alt="">
                            <div class="gallery-item-three__content">
                                <p>Project List</p>
                                <h3><a href="portfolio-single.html">Substantial
                                        Growth</a></h3>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="gallery-item-three">
                            <img src="/assets_site/images/update-1-12-2020/projects/project-1-6.jpg" alt="">
                            <div class="gallery-item-three__content">
                                <p>Project List</p>
                                <h3><a href="portfolio-single.html">Substantial
                                        Growth</a></h3>
        ...
        <section class="live-section-two jarallax" data-jarallax data-speed="0.3" data-imgPosition="50% 80%">
            <img src="/assets_site/images/update-1-12-2020/background/video-bg-1-1.jpg" alt="" class="jarallax-img">
            <div class="auto-container">
                ...
                "1199": {
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="/assets_site/images/update-1-12-2020/resources/client-1.png" alt="">
                        </div><!-- /.swiper-slide -->
                        <div class="swiper-slide">
                            <img src="/assets_site/images/update-1-12-2020/resources/client-1.png" alt="">
                        </div><!-- /.swiper-slide -->
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-4">
                        <div class="testi-block-three__single">
                            ...
                            <img src="/assets_site/images/update-1-12-2020/resources/testi-1-1.png" alt="">
                            <h3>Mike Hardson</h3>
                            <span>customer</span>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="testi-block-three__single">
                            ...
                            <img src="/assets_site/images/update-1-12-2020/resources/testi-1-2.png" alt="">
                            <h3>Mike Hardson</h3>
                            <span>customer</span>
                        </div><!-- /.testi-block-three__single -->
                    </div><!-- /.col-md-12 col-lg-4 -->
                    <div class="col-md-12 col-lg-4">
                        <div class="testi-block-three__single">
                            ...
                            <img src="/assets_site/images/update-1-12-2020/resources/testi-1-3.png" alt="">
                            <h3>Mike Hardson</h3>
                            <span>customer</span>
                        </div><!-- /.testi-block-three__single -->
                    </div><!-- /.col-md-12 col-lg-4 -->
