...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link href="/assets_site/css/bootstrap.css" rel="stylesheet">
    ...
    <!--[if lt IE 9]><script src="/assets_site/https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.3/html5shiv.js"></script><![endif]-->
    <!--[if lt IE 9]><script src="/assets_site/js/respond.js"></script><![endif]-->
</head>
           ...
           <div class="row py-5">
                ...
                <div class="col-lg-5 d-flex align-items-center">
                    <div>
                        ...
                        <a href="about.html" class="theme-btn theme-btn-dark-hover btn-style-three py-3">Entre em contato</a>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="about-section-three__content">
                            ...
                            <div class="about-section-three__summery">
                                <p>Somos uma empresa apaixonada por tecnólogia e inovação. Nosso objetivo e trazer aos nossos clientes e parceiros as melhores soluções em tecnológia para seus negócios e melhorar seus resultados </p>
                            ...
                            <ul class="list-unstyled about-section-three__list">
                                ...
                                <li>
                                    <i class="fa fa-check-circle"></i>
                                    Quer ter um <b>sistema WEB personalizado</b> para melhorar seus resultados e otimizar seu trabalho
                                </li>
                                <li>
                                    <i class="fa fa-check-circle"></i>
